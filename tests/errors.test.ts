...
describe("MultiTurnDriver Error Tests", () => {
    ...
    test("should throw error for invalid status code", async () => {
        ...
        await runErrorTest("Status Code Mismatch Test", modelConfig, "did not match expected status code");
    });
    ...
    test("should throw error for invalid request", async () => {
        ...
        await runErrorTest("Invalid Request Test", modelConfig, "Invalid Okareo API");
    });
    ...
    test("should throw error for invalid target type", async () => {
        ...
        await runErrorTest("Invalid Target Type Test", modelConfig, "Invalid target type");
    });
    ...
    test("should throw error for invalid repeats", async () => {
        ...
        await runErrorTest("Invalid Repeats Test", modelConfig, "Invalid 'repeats' value");
    });
    ...
    test("should throw error for invalid rest in next message", async () => {
        ...
        await runErrorTest("Invalid Next Message Method Test", modelConfig, "Invalid HTTP method");
    });
    ...
    test("should throw error for invalid rest in start message", async () => {
        ...
        await runErrorTest("Invalid Start Message Method Test", modelConfig, "Invalid HTTP method");
    });
    ...
    test("should throw error for invalid URL in start message", async () => {
        ...
        await runErrorTest("Missing Start URL Test", modelConfig, "Missing 'start_session_url'");
    });
    ...
    test("should throw error for missing target api key", async () => {
        ...
        await runErrorTest("Missing API Key Test", modelConfig, "Missing API key for target type");
    });
    ...
    test("should throw error for missing system prompt", async () => {
        ...
        await runErrorTest("Missing System Prompt Test", modelConfig, "Missing 'system_prompt_template' for", {
            model_api_key: "test",
        });
    });
    ...
    test("should throw error for missing start session", async () => {
        ...
        await runErrorTest("Missing Start Session Test", modelConfig, "Missing 'start_session_params'");
    });
    ...
    test("should throw error for invalid start session headers", async () => {
        ...
        await runErrorTest("Invalid Start Headers Test", modelConfig, "Invalid JSON in start_session_params headers");
    });
    ...
    test("should throw error for invalid headers in next message", async () => {
        ...
        await runErrorTest("Invalid Next Headers Test", modelConfig, "Invalid JSON in next_message_params headers");
    });
});
